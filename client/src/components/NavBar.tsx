  ...
  return (
    <div className="navbar bg-black relative z-50">
      <div className="px-4 navbar-start">
        ...
        <a href="/" className="btn btn-ghost normal-cas text-white text-xl">
          lasso
        </a>
        <ul className="menu menu-horizontal p-0">
          <li>
            <a
              href="/dustsweeper"
              className="text-bold text-white hover:bg-green-300 hover:text-black"
            >
              Dust Sweeper
            </a>
          </li>
          ...
          <li>
            <a
              href="https://lasso-donations.vercel.app/"
              target="_blank"
              rel="noreferrer"
              className="text-bold text-white hover:bg-green-300 hover:text-black"
            >
